...
void CalculateMachineParameters(machineSettingsTypeDef *ms,machineParamsTypeDef *mp){
	...
	mp->FR_SurfaceSpeed = mp->FR_RPM/60.0f * FR_circumference;
	//mp->FR_SurfaceSpeed = mp->FR_MotorRPM/60.0f * FR_circumference; initially it was this but this formula wrong
