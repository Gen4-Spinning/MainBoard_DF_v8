...
#define PAUSE_DF_OUTPUT_LENGTH 0x02
...
#define ERR_DF_OUTPUT_LENGTH 0x04
...
#define RUN_SENSOR_TOGGLE_STATE    0x0F   /* sensor toggle switch status */

/* BT information byte for AL settings from app */
#define AL_SETTINGS_FROM_APP       0x11   /* new info byte for AL params */
#define AL_SETTINGS_FROM_MB    0x12   // mainboard sends saved AL values to app
#define REQ_AL_SETTINGS_FROM_APP 0x13 // app requests AL settings

/* TLV tags for AL settings payload from app */

#define AL_KP_TYPE          0x20
#define AL_SLIVER6_TYPE     0x21
#define AL_SLIVER5_TYPE     0x22
#define AL_SLIVER4_TYPE     0x23
#define AL_TARGET_G_TYPE    0x24
// New info byte — mainboard sends calib result to app
#define AL_CALIB_DATA_FROM_MB    0x15

// New BT substate — app requests calibration run (reuses DIAGNOSTICS_FROM_APP)
#define BT_AL_CALIBRATION        0x05   // new subState value alongside BT_DIAGNOSTIC_RUN

// TLV tags for calib result
#define AL_CALIB_AVG_TYPE        0x30
#define AL_CALIB_COUNT_TYPE      0x31

#define TOGGLE_AL_FROM_APP       0x16   // app sends toggle state
#define AL_TOGGLE_TYPE           0x32   // TLV tag for toggle state in run frame
